...
ActiveRecord::Schema[8.1].define(version: 2026_06_29_015824) do
  ...
  create_table "artworks", force: :cascade do |t|
    ...
    t.index ["directed_drawing_id"], name: "index_artworks_on_directed_drawing_id"
  end
  ...
  add_foreign_key "artworks", "directed_drawings"
